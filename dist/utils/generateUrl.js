export const generateUrl = (context, data)=>{
    const { urlFieldConfig } = context.fieldConfigs;
    // Generate URL if `generateUrl` function is provided
    const generatedUrl = typeof urlFieldConfig.generateUrl === 'function' ? urlFieldConfig.generateUrl(data) : '';
...
export const generateLocalizedUrl = ({ context, data, req })=>{
